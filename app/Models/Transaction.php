...
class Transaction extends Model
{
    ...
    protected $casts = [
        ...
        'total_amount' => TomanToRial::class,
        'seller_fee' => TomanToRial::class,
        'buyer_fee' => TomanToRial::class,
        'seller_final_amount' => TomanToRial::class,
        'buyer_final_amount' => TomanToRial::class,
    ];
